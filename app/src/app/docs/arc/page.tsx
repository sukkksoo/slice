...
export const metadata = { title: "Building on Arc — Slice on Arc" };
  ...
  return (
    <>
      ...
      <Callout tone="warn" title="This is a 1,000,000,000,000x bug waiting to happen">
        ...
        Slice sidesteps it entirely by rejecting native-currency pools: Arc&apos;s Uniswap pools
      ...
      <P>
        Slice therefore accumulates its own. Every permissionless <Code>poke()</Code> records a
      ...
      <P>
        ...
        have no code at their mainnet addresses on testnet. Slice calls neither, but do not assume
