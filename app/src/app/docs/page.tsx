  ...
  return (
    <>
      ...
      <P>
        ...
        price range, you hold a non-fungible position, you remember to collect. Delta wraps all of
      ...
      <P>
        ...
        it. Delta lets you point a <Strong>fee router</Strong> at your pool, fund it with USDC, and
      ...
      <UL>
        <LI>
          ...
          pool. Delta does not run its own AMM.
        </LI>
        <LI>
